...
Source0  : https://files.pythonhosted.org/packages/fe/b5/536c775084d239df6345dccf9b043419c7e3308bc31be4c7882196abc62e/readme_renderer-43.0.tar.gz
...
%prep
%setup -q -n readme_renderer-43.0
cd %{_builddir}/readme_renderer-43.0
pushd ..
cp -a readme_renderer-43.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708969278
