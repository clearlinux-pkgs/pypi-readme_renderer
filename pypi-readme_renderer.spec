...
Version  : 37.1
Release  : 36
URL      : https://files.pythonhosted.org/packages/91/ff/5abdfa03c1685f785e6d5211cfdeb8e06f75a1162fcdb19e0eb69401a6cb/readme_renderer-37.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/91/ff/5abdfa03c1685f785e6d5211cfdeb8e06f75a1162fcdb19e0eb69401a6cb/readme_renderer-37.1.tar.gz
...
%prep
%setup -q -n readme_renderer-37.1
cd %{_builddir}/readme_renderer-37.1
pushd ..
cp -a readme_renderer-37.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662312046
