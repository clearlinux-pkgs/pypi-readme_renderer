...
%prep
%setup -q -n readme_renderer-35.0
cd %{_builddir}/readme_renderer-35.0
pushd ..
cp -a readme_renderer-35.0 buildavx2
popd
...
cp %{_builddir}/readme_renderer-35.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-readme_renderer/43a3a49bd7af636c923a5ae475395b8e29320529
