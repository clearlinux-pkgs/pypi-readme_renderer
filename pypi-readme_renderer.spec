...
Source0  : https://files.pythonhosted.org/packages/15/4e/0ffa80eb3e0d0fcc0c6b901b36d4faa11c47d10b9a066fdd42f24c7e646a/readme_renderer-36.0.tar.gz
...
%prep
%setup -q -n readme_renderer-36.0
cd %{_builddir}/readme_renderer-36.0
pushd ..
cp -a readme_renderer-36.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659971744
