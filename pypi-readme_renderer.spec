...
Source0  : https://files.pythonhosted.org/packages/5e/ce/932f615a88ab777f1424277bfdcfe9b6b686a60e5f83d896749571d8e7d9/readme_renderer-37.0.tar.gz
...
%prep
%setup -q -n readme_renderer-37.0
cd %{_builddir}/readme_renderer-37.0
pushd ..
cp -a readme_renderer-37.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661193530
